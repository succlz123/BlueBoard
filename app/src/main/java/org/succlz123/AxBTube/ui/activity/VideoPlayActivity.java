...
import org.succlz123.AxBTube.bean.acfun.AcGetH5ByVid;
...
//
//                        new DownLoadAsyncTask(VideoPlayActivity.this, path).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
//
//                        String fileName = "xx.mp4";
//                        String filePathName = VideoPlayActivity.this.getExternalFilesDir("video").getAbsolutePath() + File.separator + fileName;
//
//
//                        DownloadManager downloadManager = new DownloadManager(VideoPlayActivity.this);
//
//                        DownloadTask task = new DownloadTask(VideoPlayActivity.this);
//                        task.setUrl(path);
                ...
                RetrofitConfig.getAcContentHtml5Video().onContentResult(AcApi.getAcContentHtml5VideoUrl("2440995"), new Callback<AcGetH5ByVid>() {
                    ...
                    public void success(AcGetH5ByVid acGetH5ByVid, Response response) {
                        if (acGetH5ByVid.isSuccess() && acGetH5ByVid.getResult().getC20().getFiles().size() != 0) {
                            ...
                            DownloadTask task = new DownloadTask(VideoPlayActivity.this);
                            task.setUrl(acGetH5ByVid.getResult().getC20().getFiles().get(0).getUrl());
                            task.setPath(filePathName);
