...
public class NewAcString {
    ...
    public static final String APP_VERSION_400 = "4.0.0_beta";

    public static final String DEVICETYPE = "deviceType";
    public static final String DEVICETYPE_1 = "1";

    public static final String MARKET = "market";
    public static final String MARKET_PORTAL = "portal";
    ...
    public static final String UUID_X = "26aa4b99-61e7-31cc-a6fe-c253b01aafa6";
